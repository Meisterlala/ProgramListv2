...
Public Class FormMain
    ...
    Public Sub UpdateStartMenu()

        Dim FOLDER As String = Environment.GetFolderPath(Environment.SpecialFolder.StartMenu)

        FOLDER = FOLDER & "\Programs\ProgramList\"
        ...
        For Each element In LProgram
            ...
            MyShortcut = WshShell.CreateShortcut(FOLDER & name & ".lnk")

            MyShortcut.TargetPath = element.Path  'Specify target file full path
    ...
    ' FormAddEdit
    '
    ' 0 Program Add 1 Program Edit 2 Game Add 3 Game Edit 4 Gamelist Add 5 Gamelist Edit Save before
    ' closing the app
    ...
    ' SGamelist.Status
    '
    ' 0 Playing 1 Completed 2 Backlog 3 Dropped Changing of Tabs with redrawing
